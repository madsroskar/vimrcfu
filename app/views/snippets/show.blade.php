...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-sm-5 col-xs-12">
            <div class="score pull-right text-muted">
                ...
                <a href="{{ URL::route('vote.up', $snippet['id']) }}" title="vote up"
                   class="votelink up {{ $voted === 1 ?: 'dark' }}"><i class="fa fa-arrow-circle-up"></i></a>
                <a href="{{ URL::route('vote.down', $snippet['id']) }}" title="vote down"
                   class="votelink down {{ $voted === -1 ?: 'dark' }}"><i class="fa fa-arrow-circle-down"></i></a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-4 col-xs-12">
            ...
            <a class="btn btn-default btn-sm" href="{{ URL::route('snippet.edit', $snippet['id']) }}"
