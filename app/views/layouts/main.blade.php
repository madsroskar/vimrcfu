...
<head>
    ...
    <script>window.html5 || document.write('{{ HTML::script('
    js / vendor / html5shiv.js
    ') }}'
    )</script>
    <![endif]-->
    <link href="{{ Config::get('app.url') }}/feed" rel="alternate" type="application/rss+xml"
          title="vimrcfu - Share your best vimrc snippets.">
</head>
<body>
...
<div class="container">
    ...
    <footer class="small text-muted">
        <p class="pull-right">
            <a href="https://twitter.com/azath0th" class="twitter-follow-button" data-show-count="false">Follow
                @azath0th</a>
        ...
        <p>&copy; 2014 <a href="http://blog.no-panic.at" target="_blank">Florian Beer</a> - made with Vim - hosted by <a
                    href="http://42dev.eu" target="_blank">42dev</a><br>
